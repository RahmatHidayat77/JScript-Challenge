let json = [
  ...
  //obj = JSON.parse(json);
  console.log("All purchase made in February :");
  console.log(json[0].created_at);
  console.log(json[1].created_at);
  console.log(json[2].created_at);
  console.log("All purchase made by Ari :");
  console.log(json[0].items[0].price);
  console.log(json[0].items[1].price);
